...
| :--- | :--- | :--- | :--- |
| **10 Mai 2026 (soir)** | Web `main` jusqu'à `8f4246c` | **v2.4.2 user-feedback fixes** déployé prod | i18n + persistance + radius + consensus réel + cooldown fix + timestamp |
| **10 Mai 2026 (soir)** | iOS `fix/ios-finalization` jusqu'à `a5e6f7d` | **v2.4.2 commits locaux** | Pas encore uploadé App Store, Build 39 reste la dernière |
| **10 Mai 2026** | iOS commit `21970e8` (Build 39) | **V1 polish v2.4.1** | iOS Build 39 dispo TestFlight |
| **10 Mai 2026** | Web `main` jusqu'à `0cee051` | **V1 polish v2.4.1** déployé prod | wiseweatherapp.xyz |
